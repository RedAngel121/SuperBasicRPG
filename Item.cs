namespace SuperBasicRPG
{
    ...
    {
        None, Axe, Boomerang, Bow, Cane, Club, Crossbow, Dagger, Daibo, Explosive, Fist_Weapon, Flail, Hammer, Javelin, Mace, Magic_Orb, Pickaxe, Pistol, Polearm, Rifle, Scythe, Shotgun, Shovel, Spear, Stave, Sword, Unarmed, Wand, Whip
    }
    enum MagicalWeaponType
    {
        ...
        // organize these so they are listed in order of value... easier said than done.
    }
    enum BulkTrade
    {
